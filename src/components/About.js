...
const Stat = ({statName, statNumber, statWord}) => (
    <div className="w-third tc pa3 ba bw2 b--light-gray" style={{marginRight: -4}}>
...
const About = ({mixes}) => (
    <div className='ph3 ph4-l'>
        <div className='measure center lh-copy f4 ph3'>
            ...
            <p>
                Whether you're in to hip hop, trip hop, classic jazz, fusion jazz, afro beat or break beat... we have you covered!
            </p>
        </div>
